...
| [15](./plans/15-actors-get-state.md) | Feito | `GET /actors/:id/state` |
| [16](./plans/16-actors-roll-attack.md) | Feito | `POST /actors/:id/rolls/attack` |
...
| [23](./plans/23-filtros-escolas.md) | Feito | Escolas de magia via API |
| [24](./plans/24-filtros-categorias.md) | Feito | Categorias feat/arma/armadura/item |
| [25](./plans/25-pools-ferramentas.md) | Feito | Pools instrumento/jogo/artesão |
...
| [28](./plans/28-fatiar-character-sheet.md) | Feito | Remodelar slice da ficha |
...
| [36](./plans/36-gh-cap1-tracos.md) | Feito | GH Cap. 1 sub-escolhas |
