...
import { executeMonsterHunterTableAction } from "@/features/character/character-sheet/api/character-session.api";
...
type CombatMonsterHunterPanelProps = {
  characterId: string;
  classSlug: string;
...
/** Caçador de Monstros: Resposta Estudada, Golpe Sepulcral e guildas (C063–C065). */
export function CombatMonsterHunterPanel({
  characterId,
  classSlug,
  subclassSlug,
  level,
  ...
  state,
  onTableNote,
}: CombatMonsterHunterPanelProps) {
  const enabled = classSlug === "monster-hunter";
