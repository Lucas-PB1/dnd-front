...
import { findSpeciesDetails } from "@/entities/character-sheet/species-details";
import {
...
import { BackgroundAbilityPanel } from "@/features/character-sheet/ui/background-ability-panel";
import type { CharacterSheetFormProps } from "@/features/character-sheet/ui/character-sheet-form-props";
import { useIdentitySync } from "@/features/character-sheet/ui/hooks/use-identity-sync";
import {
  SpeciesHeritagePanel,
  SpeciesMetaStrip,
} from "@/features/character-sheet/ui/species-heritage-panel";
import {
  SheetInput,
  SheetSection,
  SheetSelect,
