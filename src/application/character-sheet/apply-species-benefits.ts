...
import { buildOriginFeatsText } from "@/application/character-sheet/apply-origin-benefits";
import type { SkillKey } from "@/domain/character-sheet/constants";
import { getSpeciesSheetDefaults } from "@/domain/character-sheet/species-details";
import {
